...
const buildProposalPreview = (lead) => {
  ...
  const monthlyPlan = {
    ...
    price: "$50-$100/mo",
    copy: "A low-friction monthly plan that includes the website itself, hosting, light updates, support, and the first version of the site built into the package.",
  };

  const depositLine = "Suggested payment structure: no large upfront build fee for now. Start with the agreed monthly plan and keep the offer simple while you build proof and reputation.";
  ...
  return {
    ...
    callGuidance: "On the call, keep the offer simple. Position this as an affordable monthly partnership for local service businesses that need a clean website without a large upfront project fee.",
